...
def create_model(input_shape, filters=[32, 64, 128], dense_units=[2000, 1000, 500],
                 pooling=False, weight=0.1, lr=0.01):
    ...
    sgd = keras.optimizers.SGD(lr=lr, momentum=0.9, decay=1e-4, )
...
if __name__ == "__main__":
    ...
    if args.train > 0:
        ...
        model = create_model((args.reshape[0], args.reshape[1], args.reshape[2]),
                             lr=args.lr_init, pooling=args.pooling, weight=args.res_weight,
                             )
