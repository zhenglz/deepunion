...
class SimpleCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.relu4(self.dropout1(self.dense1(x)))
        x = self.relu5(self.dropout2(self.dense2(x)))
        x = self.relu6(self.dropout3(self.dense3(x)))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-dropout", default=0.2, type=float,
                        help="Input, optional. Default is 0.2. \n"
                             "The drop-out rate in the fully-connected layers. \n")
